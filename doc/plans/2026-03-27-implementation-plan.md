...
**Step 4: Run fvm flutter pub get**

Run: `fvm flutter pub get`
Expected: Dependencies resolve successfully.

**Step 5: Run fvm flutter analyze**
...
Run: `fvm flutter test test/apng/chunks_test.dart`
...
Run: `fvm flutter test test/apng/encoder_test.dart`
...
Run: `fvm flutter test test/apng/decoder_test.dart`
...
Run: `fvm flutter test test/apng/`
Expected: All tests PASS.
...
Run: `fvm flutter test test/diff/frame_comparator_test.dart`
...
Run: `fvm flutter test test/diff/diff_image_test.dart`
...
Run: `fvm flutter test test/diff/report_test.dart`
...
Run: `fvm flutter test test/recorder_test.dart`
...
Run: `fvm flutter test test/comparator_test.dart`
...
**Step 4: Run fvm flutter analyze**
...
Run: `cd example && fvm flutter test --update-goldens`
...
- How golden updates work (`fvm flutter test --update-goldens`)
